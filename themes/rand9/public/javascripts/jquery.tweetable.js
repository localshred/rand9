			...
			function(data){
				...
				$.each(data, function(i,item){
					...
					$('li#tweet-'+i+'').append(
						...
						.replace(/#(.*?)(\s|$)/g, '<a href="http://search.twitter.com/search?q=%23$1" title="Search topic #$1 on twitter" target="_blank" class="hash">#$1</a> ')
						.replace(/@(.*?)(\s|\(|\)|$)/g, '<a href="http://twitter.com/$1" target="_blank">@$1</a> $2')
					);
